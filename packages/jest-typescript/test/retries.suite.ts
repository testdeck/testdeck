...
// retries require jest-circus
@suite.skip class FlakyMethodDecorator {
...
// retries require jest-circus
@suite.skip @retries(3) class FlakySuiteDecorator {
    private static runCount1 = 0;
    private static runCount2 = 0;
    private static runCount3 = 0;
...
// retries require jest-circus
@suite.skip class FlakyMethodTrait {
    private static runCount1 = 0;
    private static runCount2 = 0;
    private static runCount3 = 0;
...
// retries require jest-circus
@suite.skip(retries(3)) class FlakySuiteTrait {
    private static runCount1 = 0;
    private static runCount2 = 0;
    private static runCount3 = 0;
